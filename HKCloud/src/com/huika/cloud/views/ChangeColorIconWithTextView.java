...
public class ChangeColorIconWithTextView extends View {
	 ...
	 * 颜色
	 */
	private int mImageColor = Color.parseColor("#DF0B17");
	...
	public ChangeColorIconWithTextView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
			...
			case R.styleable.ChangeColorIconView_color:
				mImageColor = a.getColor(attr, 0x45C01A);
				break;
	...
	private void drawSourceText(Canvas canvas, int alpha) {
		...
		canvas.drawText(mText, mIconRect.left + mIconRect.width() / 2 - mTextBound.width() / 2, mIconRect.bottom
				+ mTextBound.height(), mTextPaint);
	}

	private void drawTargetText(Canvas canvas, int alpha) {
		mTextPaint.setColor(mImageColor);
