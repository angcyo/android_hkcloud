...
public class RdpUtils {
    ...
    private static int sMinKeyboardHeight = 200;
    ...
    public static int getDefKeyboardHeight(Context context) {
        ...
        if (height > 0 && sDefKeyboardHeight != height) {
            RdpUtils.setDefKeyboardHeight(context,height);
        }
     ...
     * @param height dx
     */
	public static int getMinkeyboardHeight(Context context,int height) 
    {
    	if(height == 0)return height;
    	if(height > sMinKeyboardHeight)
    	{
    		return height;
    	}
    	return sDefKeyboardHeight;
